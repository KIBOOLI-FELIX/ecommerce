...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{url('admin/category/update/'.$category->id)}}" enctype="multipart/form-data" method='POST'>
                    @csrf
                    @method('PUT')
                    @if ($errors->any())
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type='checkbox' name='status' {{$category->status=='1'? 'checked':''}} class='form-check'/>
                        </div>
                        <div class="col-md-12">
                            <h4>SEO Tags</h4>
                        </div>
